...
class QuizState extends State<QuizThreePointOne> {
  var answers = [
  ...
  String questionAudio = '3.1_QwhichaddsERformoreESTformost.mp3';
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 3.1");
