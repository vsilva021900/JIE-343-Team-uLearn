...
class QuizSixPointFive extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizSixPointFive> {
  var answers = [
  ...
  String questionAudio = "dropbox/SectionSix/SixPointFive/#6.3_Q_HAVE_whichISacontractionwithHave.mp3";

  var answerOrder = [0, 1, 2, 3];
  int prevCorrect = -1; // prevent same correct answer multiple times in a row

  int index = 4; // for calling StreakSix methods
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 6.5");
