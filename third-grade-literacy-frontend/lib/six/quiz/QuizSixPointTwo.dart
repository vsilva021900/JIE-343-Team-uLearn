...
class QuizSixPointTwo extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizSixPointTwo> {
  var answers = [
  ...
  String questionAudio = "dropbox/SectionSix/SixPointTwo/#6.2_Q_IS_whichwordisacontractionwithIS.mp3";
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 6.2");
