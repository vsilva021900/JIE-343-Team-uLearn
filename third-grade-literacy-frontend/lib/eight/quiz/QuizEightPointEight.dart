...
class QuizEightPointEight extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizEightPointEight> {
  var answers = [
  ...
  String questionAudio = "dropbox/SectionEight/EightPointEight/#8.8_Q_WhichWordHasAPrefixThatMeansTooMuch.mp3";

  var answerOrder = [0, 1, 2, 3];
  int prevCorrect = -1; // prevent same correct answer multiple times in a row

  int index = 7; // for calling StreakNine methods
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 8.8");
