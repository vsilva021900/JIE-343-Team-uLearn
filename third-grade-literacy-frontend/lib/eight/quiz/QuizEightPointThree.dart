...
class QuizEightPointThree extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizEightPointThree> {
  var answers = [
  ...
  String questionAudio = "dropbox/SectionEight/EightPointThree/#8.3_Q_WhichWordHasAPrefixThatMeansNot.mp3";

  var answerOrder = [0, 1, 2, 3];
  int prevCorrect = -1; // prevent same correct answer multiple times in a row

  int index = 2; // for calling StreakNine methods
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        ...
                        if (attempt == 0) {
                          globals.pushUserDataForFocusItem(attempt + 1, "Quiz 8.3");
