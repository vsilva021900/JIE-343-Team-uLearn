...
class QuizEightPointNine extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizEightPointNine> {
  var answers = [
  ...
  String questionAudio = "dropbox/SectionEight/EightPointNine/#8.9_Q_WhichWordHasAPrefixThatMeansTooLittle.mp3";

  var answerOrder = [0, 1, 2, 3];
  int prevCorrect = -1; // prevent same correct answer multiple times in a row

  int index = 8; // for calling StreakNine methods
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 8.9");
