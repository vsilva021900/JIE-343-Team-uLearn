...
class QuizFourPointEight extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizFourPointEight> {
  var answers =      [
  ...
  int index = 8; // first try correct answer streak
  int attempt = 0; // how many tries before answering correctly

  String questionAudio = '4.8_Qwhichirregularneedtoremember.mp3';
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 4.8");
