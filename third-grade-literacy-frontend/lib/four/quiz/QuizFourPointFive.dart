...
class QuizFourPointFive extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizFourPointFive> {
  var answers =     [ ['bus', 'dress', 'glass', 'guess', 'kiss', 'walrus', // 4.2
  ...
  int index = 5; // first try correct answer streak
  int attempt = 0; // how many tries before answering correctly

  String questionAudio = '4.5_Q_whichwordjustaddsES use this.mp3';
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 4.5");
