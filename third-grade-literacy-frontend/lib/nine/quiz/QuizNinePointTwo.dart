...
class QuizNinePointTwo extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizNinePointTwo> {
  var answers = [
  ...
  String questionAudio = "dropbox/SectionNine/NinePointTwo/#9.2_QwhichwordsuffixmeansFullOf.mp3";

  var answerOrder = [0, 1, 2, 3];
  int prevCorrect = -1; // prevent same correct answer multiple times in a row

  int index = 1; // for calling StreakNine methods
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 9.2");
