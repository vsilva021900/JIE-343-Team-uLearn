...
class QuizNinePointSeven extends StatefulWidget {
  @override
  QuizState createState() => QuizState();
}

class QuizState extends State<QuizNinePointSeven> {
  var answers = [
  ...
  String questionAudio = "dropbox/SectionNine/NinePointSeven/#9.7_QwhichhassuffixmeansBeingorHaving.mp3";

  var answerOrder = [0, 1, 2, 3];
  int prevCorrect = -1; // prevent same correct answer multiple times in a row

  int index = 6; // for calling StreakNine methods
              ...
              children: [
                ...
                GestureDetector(
                    onTap: () {
                      ...
                      if (answerOrder[0] == 0) {
                        globals.pushUserDataForFocusItem(attempt + 1, "Quiz 9.7");
